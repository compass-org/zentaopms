...
$config->bug->list->exportFields = 'id, product, branch, module, project, story, task, 
    ...
    openedBy, openedDate, openedBuild, 
    assignedTo, assignedDate,createFrom,
    resolvedBy, resolution, resolvedBuild, resolvedDate,
    closedBy, closedDate, 
    duplicateBug, linkBug, 
    case,
...
$config->bug->datatable->fieldList['createFrom']['title']    = 'createFromAB';
$config->bug->datatable->fieldList['createFrom']['fixed']    = 'no';
$config->bug->datatable->fieldList['createFrom']['width']    = '80';
$config->bug->datatable->fieldList['createFrom']['required'] = 'no';
