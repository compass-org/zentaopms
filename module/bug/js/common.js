$(function()
{
    ...
    if(page == 'create')
    {
        ...
        if(!createFrom) setCreateFrom(moduleID, productID);
        notice();
    }
...
/**
 * Load team members of the project as createFrom list.
 *
 * @param  int     $projectID
 * @access public
 * @return void
 */
function loadCreateFrom(projectID)
{
    link = createLink('bug', 'ajaxLoadAssignedTo', 'projectID=' + projectID + '&selectedUser=' + $('#createFrom').val());
